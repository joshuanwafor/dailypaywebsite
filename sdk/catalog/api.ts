 ...
 * @export
 * @interface DailyPayJobStep4
 */
export interface DailyPayJobStep4 {
    /**
     * 
     * @type {string}
     * @memberof DailyPayJobStep4
     */
    'encryptedEmail': string;
    /**
     * 
...
export const DailypayResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {DailyPayJobStep4} dailyPayJobStep4 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        approveMandateRequest: async (dailyPayJobStep4: DailyPayJobStep4, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'dailyPayJobStep4' is not null or undefined
            assertParamExists('approveMandateRequest', 'dailyPayJobStep4', dailyPayJobStep4)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(dailyPayJobStep4, localVarRequestOptions, configuration)
...
export const DailypayResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async approveMandateRequest(dailyPayJobStep4: DailyPayJobStep4, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.approveMandateRequest(dailyPayJobStep4, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const DailypayResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        approveMandateRequest(dailyPayJobStep4: DailyPayJobStep4, options?: RawAxiosRequestConfig): AxiosPromise<ApiResponseDto> {
            return localVarFp.approveMandateRequest(dailyPayJobStep4, options).then((request) => request(axios, basePath));
        },
        /**
         * Resource to claim DailyPay money credited to DailyPay wallet
         * @summary Claim DailyPay money credited to DailyPay wallet
...
export class DailypayResourceApi extends BaseAPI {
     ...
     * @memberof DailypayResourceApi
     */
    public approveMandateRequest(dailyPayJobStep4: DailyPayJobStep4, options?: RawAxiosRequestConfig) {
        return DailypayResourceApiFp(this.configuration).approveMandateRequest(dailyPayJobStep4, options).then((request) => request(this.axios, this.basePath));
    }
