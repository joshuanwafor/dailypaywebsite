...
12. [MOBILE APPLICATION LICENCE](#mobile-application-licence)
13. [SOCIAL MEDIA](#social-media)
14. [THIRD-PARTY WEBSITES AND CONTENT](#third-party-websites-and-content)
15. [SERVICES MANAGEMENT](#services-management)
16. [PRIVACY POLICY](#privacy-policy)
17. [TERM AND TERMINATION](#term-and-termination)
18. [MODIFICATIONS AND INTERRUPTIONS](#modifications-and-interruptions)
19. [GOVERNING LAW](#governing-law)
20. [DISPUTE RESOLUTION](#dispute-resolution)
21. [CORRECTIONS](#corrections)
22. [DISCLAIMER](#disclaimer)
23. [LIMITATIONS OF LIABILITY](#limitations-of-liability)
24. [INDEMNIFICATION](#indemnification)
25. [USER DATA](#user-data)
26. [ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES](#electronic-communications-transactions-and-signatures)
27. [SMS TEXT MESSAGING](#sms-text-messaging)
28. [MISCELLANEOUS](#miscellaneous)
29. [CONTACT US](#contact-us)

## 1. OUR SERVICES<a id="our-services"></a>

The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.

## 2. INTELLECTUAL PROPERTY RIGHTS<a id="intellectual-property-rights"></a>
...
By sending us Submissions through any part of the Services you: - confirm that you have read and agree with our '[PROHIBITED ACTIVITIES](#prohibited-activities)' and will not post, send, publish, upload, or transmit through the Services any Submission that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading; - to the extent permissible by applicable law, waive any and all moral rights to any such Submission; - warrant that any such Submissions are original to you or that you have the necessary rights and licences to submit such Submissions and that you have full authority to grant us the above-mentioned rights in relation to your Submissions; and - warrant and represent that your Submissions do not constitute confidential information.

You are solely responsible for your Submissions and you expressly agree to reimburse us for any and all losses that we may suffer because of your breach of (a) this section, (b) any third party's intellectual property rights, or (c) applicable law.

## 3. USER REPRESENTATIONS<a id="user-representations"></a>
...
## 4. USER REGISTRATION <a id="user-registration"></a>
...
## 10. CONTRIBUTION LICENCE <a id="contribution-licence"></a>
...
## 11. GUIDELINES FOR REVIEWS <a id="guidelines-for-reviews"></a>
...
## 12. MOBILE APPLICATION LICENCE <a id="mobile-application-licence"></a>
...
1. The licence granted to you for our App is limited to a non-transferable licence to use the application on a device that utilizes the Apple iOS or Android operating systems, as applicable, and in accordance with the usage rules set forth in the applicable App Distributor's terms of service.
...
## 13. SOCIAL MEDIA <a id="social-media"></a>
...
1. We may access, make available, and store (if applicable) any content that you have provided to and stored in your Third-Party Account (the "Social Network Content") so that it is available on and through the Services via your account, including without limitation any friend lists.
...
## 14. THIRD-PARTY WEBSITES AND CONTENT <a id="third-party-websites-and-content"></a>
...
## 15. SERVICES MANAGEMENT <a id="services-management"></a>
...
## 16. PRIVACY POLICY <a id="privacy-policy"></a>

We care about data privacy and security. By using the Services, you agree to be bound by our Privacy Policy posted on the Services, which is incorporated into these Legal Terms. Please be advised the Services are hosted in Nigeria. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in Nigeria, then through your continued use of the Services, you are transferring your data to Nigeria, and you expressly consent to have your data transferred to and processed in Nigeria.

## 17. TERM AND TERMINATION <a id="term-and-termination"></a>
...
## 18. MODIFICATIONS AND INTERRUPTIONS <a id="modifications-and-interruptions"></a>
...
## 21. CORRECTIONS <a id="corrections"></a>

There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.

## 22. DISCLAIMER <a id="disclaimer"></a>
...
## 23. LIMITATIONS OF LIABILITY <a id="limitations-of-liability"></a>
...
## 24. INDEMNIFICATION <a id="indemnification"></a>
...
## 25. USER DATA <a id="user-data"></a>

We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.

## 26. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES <a id=" #electronic-communications-transactions-and-signatures"></a>
...
## 27. SMS TEXT MESSAGING <a id="sms-text-messaging"></a>

### Opting Out

Update account preferences to cancel notifications.
...
## 29. CONTACT US <a id="contact-us"></a>
